namespace KRCON.Data.Models
{
    ...
    [Serializable]
    public class KRV_SURVEY_ITEM_TEXT : DataEntityBase<int>
    {
        ...
        public virtual string CONTENT_HEADER2 { get; set; }

        public virtual string CONTENT_HEADER3 { get; set; }

        public virtual string CONTENT_HEADER4 { get; set; }

        public virtual string CONTENT_HEADER5 { get; set; }
        ...
        public virtual bool LAST_AMEND { get; set; }
        ...
        public virtual bool OTHER_CDG { get; set; }

        public virtual bool OTHER_IIHM { get; set; }

        public virtual bool OTHER_IMSBC { get; set; }
        ...
        public virtual int SURVEY_ITEM_TEXT_ID { get; set; }
