namespace KRCON.Data.Models
{
    ...
    [Serializable]
    public class KRV_SURVEY_ITEM_EXCEL : DataEntityBase<int>
    {
        ...
        public virtual string C_DETAIL { get; set; }

        public virtual string C_TITLE { get; set; }
        ...
        public virtual string E_DETAIL { get; set; }

        public virtual string E_TITLE { get; set; }
        ...
        public virtual string K_DETAIL { get; set; }

        public virtual string K_TITLE { get; set; }
